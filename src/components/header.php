...
<head>
    ...
    <script type="module">
        ...
        window.popup1 = function(title, content) {
            w2popup.open({
                title: title,
                text: content
            })
...
<div style="width: 100%; margin: auto; background-color: #a9be7b; height:60px;border-radius:4px;position:fixed;top:0;display: flex; align-items: center;">
    <input type="button" value="Logout" name="logout" onclick="window.location.href = '/src/user/logout.php'" style="background-color: rgba(238, 242, 229);
           position: absolute; 
           left: 2px;" />
</div>
